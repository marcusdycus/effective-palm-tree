...
>(
  (
    { className, children, position = "popper", enableDialogScroll, ...props },
    ref,
  ) => (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        {...props}
        onWheel={(e) => {
          if (enableDialogScroll) e.stopPropagation(); // Per radix-ui issue #1159 (https://github.com/radix-ui/primitives/issues/1159#issuecomment-2132786650)
        }}
      >
